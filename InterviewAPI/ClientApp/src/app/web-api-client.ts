...
export interface IInterviewsClient {
    get(): Observable<InterviewVm>;
    create(command: CreateInterviewCommand): Observable<number>;
    update(id: number, command: UpdateInterviewCommand): Observable<FileResponse>;
...
export class InterviewsClient implements IInterviewsClient {
    ...
    get(): Observable<InterviewVm> {
        let url_ = this.baseUrl + "/api/Interviews";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<InterviewVm>><any>_observableThrow(e);
                }
            } else
                return <Observable<InterviewVm>><any>_observableThrow(response_);
        }));
    }

    protected processGet(response: HttpResponseBase): Observable<InterviewVm> {
        ...
        if (status === 200) {
            ...
            result200 = InterviewVm.fromJS(resultData200);
        ...
        return _observableOf<InterviewVm>(<any>null);
    }
    ...
    update(id: number, command: UpdateInterviewCommand): Observable<FileResponse> {
        let url_ = this.baseUrl + "/api/Interviews/{id}";
...
export class InterviewVm implements IInterviewVm {
    interviews?: InterviewDto[] | undefined;

    constructor(data?: IInterviewVm) {
        if (data) {
        ...
        if (_data) {
            if (Array.isArray(_data["interviews"])) {
                ...
                for (let item of _data["interviews"])
                    this.interviews!.push(InterviewDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): InterviewVm {
        data = typeof data === 'object' ? data : {};
        let result = new InterviewVm();
        result.init(data);
        return result;
    }
...
export interface IInterviewVm {
    interviews?: InterviewDto[] | undefined;
}

export class InterviewDto implements IInterviewDto {
    id?: number;
    question?: string | undefined;
    allAnswerRequired?: boolean;
    answerCount?: number;
    interviewUnlimited?: boolean;
    interviewEnd?: Date | undefined;
    responsesCountForPublish?: number;
    responsesIsPublic?: boolean;
    options?: Option[] | undefined;

    constructor(data?: IInterviewDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.allAnswerRequired = _data["allAnswerRequired"];
            this.answerCount = _data["answerCount"];
            this.interviewUnlimited = _data["interviewUnlimited"];
            this.interviewEnd = _data["interviewEnd"] ? new Date(_data["interviewEnd"].toString()) : <any>undefined;
            this.responsesCountForPublish = _data["responsesCountForPublish"];
            this.responsesIsPublic = _data["responsesIsPublic"];
    ...
    static fromJS(data: any): InterviewDto {
        data = typeof data === 'object' ? data : {};
        let result = new InterviewDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["allAnswerRequired"] = this.allAnswerRequired;
        data["answerCount"] = this.answerCount;
        data["interviewUnlimited"] = this.interviewUnlimited;
        data["interviewEnd"] = this.interviewEnd ? this.interviewEnd.toISOString() : <any>undefined;
        data["responsesCountForPublish"] = this.responsesCountForPublish;
        data["responsesIsPublic"] = this.responsesIsPublic;
...
export class Option extends AuditableEntity implements IOption {
    id?: number;
    ...
    init(_data?: any) {
        ...
        if (_data) {
            this.id = _data["id"];
            this.interview = _data["interview"] ? Interview.fromJS(_data["interview"]) : <any>undefined;
            this.interviewId = _data["interviewId"];
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["id"] = this.id;
        data["interview"] = this.interview ? this.interview.toJSON() : <any>undefined;
...
export interface IOption extends IAuditableEntity {
    id?: number;
    interview?: Interview | undefined;
    interviewId?: number;
    title?: string | undefined;
...
export class Interview extends AuditableEntity implements IInterview {
    id?: number;
    question?: string | undefined;
    ...
    init(_data?: any) {
        ...
        if (_data) {
            this.id = _data["id"];
            this.question = _data["question"];
            this.allOptionRequired = _data["allOptionRequired"];
    ...
    static fromJS(data: any): Interview {
        data = typeof data === 'object' ? data : {};
    ...
    toJSON(data?: any) {
        ...
        data["id"] = this.id;
        data["question"] = this.question;
        data["allOptionRequired"] = this.allOptionRequired;
...
export interface IInterview extends IAuditableEntity {
    id?: number;
    question?: string | undefined;
    allOptionRequired?: boolean;
    optionCount?: number;
...
export class Users implements IUsers {
    ...
    init(_data?: any) {
        if (_data) {
            this.id = _data["id"];
            this.tokenGuid = _data["tokenGuid"];
        }
    }
...
export class CreateInterviewCommand implements ICreateInterviewCommand {
    question?: string | undefined;
    allAnswerRequired?: boolean;
    answerCount?: number;
    ...
    constructor(data?: ICreateInterviewCommand) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateInterviewCommand {
        data = typeof data === 'object' ? data : {};
        let result = new CreateInterviewCommand();
        result.init(data);
        return result;
    }
...
export interface ICreateInterviewCommand {
    question?: string | undefined;
    allAnswerRequired?: boolean;
    answerCount?: number;
    answers?: string[] | undefined;
...
export class UpdateInterviewCommand implements IUpdateInterviewCommand {
    id?: number;
    question?: string | undefined;
    allAnswerRequired?: boolean;
    answerCount?: number;
    ...
    constructor(data?: IUpdateInterviewCommand) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): UpdateInterviewCommand {
        data = typeof data === 'object' ? data : {};
        let result = new UpdateInterviewCommand();
        result.init(data);
        return result;
    }
...
export interface IUpdateInterviewCommand {
    id?: number;
    question?: string | undefined;
    allAnswerRequired?: boolean;
    answerCount?: number;
